//
//  XFJPleaseUpPerfectPhotosView.m
//  TravelingManage
//
...
@interface XFJPleaseUpPerfectPhotosView() <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation XFJPleaseUpPerfectPhotosView
...
- (UILabel *)carPhotosMessage_label
{
    if (_carPhotosMessage_label == nil) {
        ...
        _carPhotosMessage_label.text = @"请上传车辆正面照片(包含车牌)最多6张";
