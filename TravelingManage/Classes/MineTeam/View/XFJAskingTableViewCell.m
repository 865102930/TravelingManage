...
@interface XFJAskingTableViewCell()
...
@implementation XFJAskingTableViewCell
...
- (void)setFindTeamInfoByStateItem:(XFJFindTeamInfoByStateItem *)findTeamInfoByStateItem
{
    ...
    self.taskStatus_label.text = [NSString stringWithFormat:@"%@",@"待评价任务"];
    [self.cancel_button setHidden:YES];
    [self.status_button setTitle:@"评价"forState:UIControlStateNormal];
