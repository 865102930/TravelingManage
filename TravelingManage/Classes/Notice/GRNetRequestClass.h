...
@interface GRNetRequestClass : NSObject
...
+(void)GET:(NSString *)url
    params:(NSDictionary *)params success:(ResponseSuccess)success
...
+(void)GET:(NSString *)url baseURL:(NSString *)baseUrl
    params:(NSDictionary *)params success:(ResponseSuccess)success fail:(ResponseFail)fail;
