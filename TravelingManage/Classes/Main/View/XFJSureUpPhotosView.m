//
//  XFJSureUpPhotosView.m
//  TravelingManage
//
//  Created by 肖锋 on 2017/3/12.
//  Copyright © 2017年 xiaoFeng. All rights reserved.
//

#import "XFJSureUpPhotosView.h"

@interface XFJSureUpPhotosView()
...
@implementation XFJSureUpPhotosView
...
- (UIButton *)commit_button
{
    if (_commit_button == nil) {
        ...
        [_commit_button setTitle:@"确认上传" forState:UIControlStateNormal];
        ...
        [_commit_button addTarget:self action:@selector(sureUpButtonClick) forControlEvents:UIControlEventTouchUpInside];
    }
    return _commit_button;
}

- (void)sureUpButtonClick
{
    if (self.sureUpDataButtonClickBlock) {
        self.sureUpDataButtonClickBlock();
    }
}
