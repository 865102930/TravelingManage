...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (!backButtonImage) {
        backButtonImage = [UIImage originalWithImage:kDefaultBackImageName];
    }
...
- (void)setUpPanGesture
{
    ...
    //清空代理,不让代理实现侧滑功能,因为自己手动通过添加手势的方法,设置了侧滑功能
